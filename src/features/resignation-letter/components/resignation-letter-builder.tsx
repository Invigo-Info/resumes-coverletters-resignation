...
import { StepShell } from "@/features/resignation-letter/components/step-shell";
import {
  HeadingStep,
  RecipientStep,
  PositionStep,
  ...
  AssistanceStep,
  ContactsStep,
} from "@/features/resignation-letter/components/steps";
import {
  ...
  canProceed,
  type RLStep,
} from "@/features/resignation-letter/store/resignation-letter-store";
import { toISODate } from "@/features/resignation-letter/lib/format";
import {
  RESIGNATION_WRITE_BASE,
  isResignationSlug,
} from "@/utilities/section-routes";
import { useResignationLetterAutosave } from "@/features/resignation-letter/store/resignation-letter-documents-store";
