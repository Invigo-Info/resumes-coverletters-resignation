...
import { useResignationLetterStore, isValidEmail, isValidPhone } from "@/features/resignation-letter/store/resignation-letter-store";
import { RL_REASONS, RL_OTHER_REASON, RL_GRATITUDE } from "@/features/resignation-letter/lib/suggestions";
import { RichTextEditor } from "@/features/resume-builder/components/rich-text-editor";
import { RLDatePicker } from "@/features/resignation-letter/components/date-picker";
