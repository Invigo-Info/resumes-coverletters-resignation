...
import { formatLetterDate, htmlToText, previewOpeningLine } from "@/features/resignation-letter/lib/format";
import type { ResignationLetterDoc } from "@/features/resignation-letter/lib/mock-data";
