...
import { StepHeading, OptionRadioCard } from "@/features/cover-letter/components/widgets";
import {
  JobDetailsStep,
  DesiredTitleStep,
  SkillsStep,
  ...
  StrengthsStep,
  PersonalStep,
} from "@/features/cover-letter/components/steps";
import {
  useCoverLetterStore,
  phaseForStep,
  progressForStep,
  ...
  canProceed,
  type CLStep,
} from "@/features/cover-letter/store/cover-letter-store";
import {
