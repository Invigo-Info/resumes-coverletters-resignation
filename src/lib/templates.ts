...
export const templates: ResumeTemplate[] = [
  ...
  { id: "leadership", name: "Leadership", used: 4523, categories: ["Professional"], image: "/templates/napoleon.jpg", preset: { columns: "centered", dark: false, font: "georgia", color: "#111827" } },
  ...
  { id: "specialist", name: "Specialist", used: 2734, categories: ["Professional"], image: "/templates/shakespeare.jpg", preset: { columns: "centered", dark: false, font: "georgia", color: "#111827" } },
  { id: "classic-ats", name: "Classic ATS", used: 4102, categories: ["ATS-friendly", "Simple"], image: "/templates/bentz.jpg", preset: { columns: "centered", dark: false, font: "georgia", color: "#111827" } },
  ...
  { id: "simple", name: "Simple", used: 3142, categories: ["Simple", "Student"], image: "/templates/ive.jpg", preset: { columns: "centered", dark: false, font: "georgia", color: "#111827" } },
  { id: "functional", name: "Functional", used: 2673, categories: ["ATS-friendly"], image: "/templates/ford.jpg", preset: { columns: "centered", dark: false, font: "georgia", color: "#111827" } },
  ...
  { id: "essential", name: "Essential", used: 3924, categories: ["Simple", "Student"], image: "/templates/turing.jpg", preset: { columns: "right", dark: false, font: "georgia", color: "#334155" } },
  { id: "executive", name: "Executive", used: 2891, categories: ["Professional"], image: "/templates/curie.jpg", preset: { columns: "centered", dark: false, font: "georgia", color: "#111827" } },
];
